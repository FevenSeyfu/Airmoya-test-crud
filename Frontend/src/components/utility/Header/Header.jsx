    ...
    <header className="w-full h-20 lg:h-24 flex flex-row items-center justify-between bg-light-purple px-4 md:px-6 relative">
      ...
      <nav className="hidden md:flex text-right">
        <ul className="flex flex-row items-center justify-end gap-x-4">
          <li>
            <Link
              className="md:text-xl lg:text-2xl   hover:text-dark-blue underline-offset-4 hover:underline transition-colors duration-300"
              to="/"
            >
              Home
            </Link>
        ...
        <div className="fixed top-20 right-0 h-screen w-1/2 bg-white shadow-lg shadow-light-purple  py-6 z-10">
          <ul className="flex flex-col items-start">
            <li className="group w-full">
              <Link
                className="w-full text-2xl  group-hover:bg-veryLight-purple group-hover:text-purple border-l-8 border-white hover:border-purple px-5 py-4 transition-colors duration-300 flex items-center gap-2 "
                to="/"
                onClick={toggleMenu}
              >
                <IoMdHome size={24} />
